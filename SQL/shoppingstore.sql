...
(11, 1, 1, '李小明', '0912345678', '407', '工業區一路100號', '2022-10-26 09:47:25'),
(12, 1, 2, '林小強', '0934567891', '407', '工業區一路100號', '2022-10-26 09:52:00');
...
(1, 2, 2, 1, '1666778015165228', 1, '::1', '2022-10-26 09:33:56'),
(2, 2, 4, 1, '1666778015165228', 1, '::1', '2022-10-26 09:33:59');
...
(1, 'test@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, '李小明', 'A123456789', '2022-10-26', '', '2022-10-26 09:47:25'),
(2, 'te@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, '林小強', 'A223456789', '2022-10-26', '', '2022-10-26 09:52:00');
...
(1, 2, 'MSI PRO DP130 12-295TW-SP5 特仕版', 'i5-12400/24G/GTX1650 4G/W11', 27990, 1, '<div class=\"drop-box\">\r\n			\r\n				<meta itemprop=\"description\" content=\"MSI PRO DP130 12-295TW-SP5(i5-12400/24G/1TB HDD+256G SSD/GTX1650 4G/W11)特仕版\">\r\n				<p></p><p class=\"ecTitle\">商品規格</p><div class=\"longDesc\"><p>處 理 器：Intel Core i5-12400<br>記 憶 體：8G DDR4(內建) +16G DDR4(升級加裝)<br> 硬 碟：256G PCIE SSD + 1TB HDD<br>顯 示 卡：NVIDIA GTX1650 4G(升級加裝)<br>網 路：Realtek® RTL8111H<br>無線網路：Intel AC 9462 or Intel Wi-Fi 6 AX201<br> 作業系統：Windows 11 Home</p></div><style>.ecTable{width:100%;border:1px solid gray;}.ecTable td{border:1px solid gray;font-size:14px}.ecTable .td1{width:30%;height:25px;padding:5px;line-height:25px;background-color:#eeeeee;text-align:center;font-weight:bold}.ecTable .td2{padding:5px;letter-spacing:1px;color:#4c4c4c}.ecTitle{font-size:18px;font-weight:bold;color:#009f9f;margin:5px 0 5px 0;} .longDesc p{margin-bottom:16px}</style><p></p>', '2022-10-19 07:15:23'),
(2, 2, 'DELL Vostro 3910 電腦', 'i5雙碟 獨顯 Win11P', 28990, 1, '<div class=\"drop-box\">\r\n			\r\n				<meta itemprop=\"description\" content=\"DELL Vostro 3910 i5雙碟獨顯Win11P電腦\">\r\n				<p></p><p class=\"ecTitle\">商品規格</p><div class=\"longDesc\"><p>處 理 器：Intel Core i5-12400F<br>記 憶 體：8GB DDR4 200MHz<br> 硬 碟：1T + 256G M.2 SSD<br>光 碟 機：無<br>顯 示 卡：NVIDIA GeForce GTX 1650 SUPER 4GB<br>其 他：802.11 ax 2x2 + Bluetooth 5.1<br>螢幕輸出介面：DP．HDMI<br>鍵鼠組：原廠有線鍵鼠組<br>電源供應：300W<br>作業系統：Windows 11 專業版 (64 bit)<br>保固：原廠三年遠端診斷後到府服務</p></div><style>.ecTable{width:100%;border:1px solid gray;}.ecTable td{border:1px solid gray;font-size:14px}.ecTable .td1{width:30%;height:25px;padding:5px;line-height:25px;background-color:#eeeeee;text-align:center;font-weight:bold}.ecTable .td2{padding:5px;letter-spacing:1px;color:#4c4c4c}.ecTitle{font-size:18px;font-weight:bold;color:#009f9f;margin:5px 0 5px 0;} .longDesc p{margin-bottom:16px}</style><p></p>', '2022-10-19 07:39:06'),
(3, 5, '美光 Micron Crucial【P5 Plus】SSD 固態硬碟', '500G M.2 2280 PCIe', 2099, 1, '<div class=\"drop-box\">\r\n			\r\n				<meta itemprop=\"description\" content=\"美光 Micron Crucial【P5 Plus】500G M.2 2280 PCIe SSD 固態硬碟\">\r\n				<p></p><p class=\"ecTitle\">商品規格</p><div class=\"longDesc\"><p>讀取6600MB/s;寫入4000MB/s<br>採用美光176層TLC NAND\r\n<br>採用最新 Gen4 NVMe 技術<br>以硬體為基礎的全碟加密<br>附免費複製軟體<br>內建自動溫度保護裝置 避免商品過熱<br>支援TRIM.SMART.ECC<br>五年有限保固</p></div><style>.ecTable{width:100%;border:1px solid gray;}.ecTable td{border:1px solid gray;font-size:14px}.ecTable .td1{width:30%;height:25px;padding:5px;line-height:25px;background-color:#eeeeee;text-align:center;font-weight:bold}.ecTable .td2{padding:5px;letter-spacing:1px;color:#4c4c4c}.ecTitle{font-size:18px;font-weight:bold;color:#009f9f;margin:5px 0 5px 0;} .longDesc p{margin-bottom:16px}</style><p></p>', '2022-10-19 08:50:22'),
(4, 7, '羅技G G413 SE 機械式遊戲鍵盤', NULL, 1880, 1, '<div class=\"drop-box\">\r\n			\r\n				<meta itemprop=\"description\" content=\"羅技G G413 SE 機械式遊戲鍵盤\">\r\n				<p></p><p class=\"ecTitle\">商品規格</p><div class=\"longDesc\"><p>觸感機械軸(棕軸)<br>耐熱耐磨PBT鍵帽<br>白光LED背光增強焦點、清晰度<br>黑色拉絲鋁質頂殼</p></div><style>.ecTable{width:100%;border:1px solid gray;}.ecTable td{border:1px solid gray;font-size:14px}.ecTable .td1{width:30%;height:25px;padding:5px;line-height:25px;background-color:#eeeeee;text-align:center;font-weight:bold}.ecTable .td2{padding:5px;letter-spacing:1px;color:#4c4c4c}.ecTitle{font-size:18px;font-weight:bold;color:#009f9f;margin:5px 0 5px 0;} .longDesc p{margin-bottom:16px}</style><p></p>', '2022-10-26 09:05:31');
...
CREATE TABLE `product_img` (
  ...
  `p_id` int(10) NOT NULL COMMENT '產品編號',
  `img_file` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '圖檔編號',
...
(1, 1, '000001_1665738916.jpg', 1, '2022-10-19 07:04:18'),
(2, 2, '000001_1666064851.webp', 1, '2022-10-19 07:36:38'),
(3, 3, '000001_1634894093.jpg', 1, '2022-10-19 08:49:03'),
(4, 4, '000001_1666694478.jpg', 1, '2022-10-26 09:04:19');
...
(1, 1, 'fa-file', '3C', 1, 0, '2022-10-17 08:22:02'),
(2, 2, 'fa-file', '桌電', 1, 1, '2022-10-17 08:24:30'),
(3, 2, 'fa-file', '筆電', 2, 1, '2022-10-17 08:25:43'),
(4, 2, 'fa-file', 'CPU', 3, 1, '2022-10-17 08:26:07'),
(5, 2, 'fa-file', 'SSD', 4, 1, '2022-10-17 08:26:38'),
(6, 1, 'fa-file', '周邊', 2, 0, '2022-10-17 08:27:25'),
(7, 2, 'fa-file', '鍵盤', 1, 6, '2022-10-26 09:09:50'),
(8, 2, 'fa-file', '滑鼠', 2, 6, '2022-10-26 09:09:56');
...
('1666778015165228', 2, 12, 1, 1, NULL, '2022-10-26 09:53:35');
...
--
ALTER TABLE `addbook`
  MODIFY `addressid` int(10) NOT NULL AUTO_INCREMENT COMMENT '地址ID', AUTO_INCREMENT=13;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `cart`
--
ALTER TABLE `cart`
  MODIFY `cartid` int(10) NOT NULL AUTO_INCREMENT COMMENT '購物車編號', AUTO_INCREMENT=3;
...
--
ALTER TABLE `product`
  MODIFY `p_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '產品編號', AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `product_img`
--
ALTER TABLE `product_img`
  MODIFY `img_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '圖檔編號', AUTO_INCREMENT=5;
